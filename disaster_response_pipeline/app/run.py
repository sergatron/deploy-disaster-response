...
# sys.path.append('C:\\Users\\smouz\\OneDrive\\Desktop\\deploy_project\\disaster-response-project\\disaster_response_pipeline_project\\models')
...
# if len(sys.argv) == 1:
#     # file path to pcikled model
#     model_path = sys.argv[1:]
# else:
#     print("Please specify correct file path to pickled model.")
